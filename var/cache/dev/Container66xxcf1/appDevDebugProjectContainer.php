...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NsqKM10O2Y', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('klwXUXI-cW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('h8NFL0-WRP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a8EjP+FZXo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qCkmXS+fD5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/Client/PlanningBundle/Resources/views'), 'ClientPlanning');
        $instance->addPath(($this->targetDirs[3].'/src/Client/PlanningBundle/Resources/views'), '!ClientPlanning');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'ClientPlanningBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Client/PlanningBundle'),
                    'namespace' => 'Client\\PlanningBundle',
                ],
                'FOSUserBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ClientPlanningBundle' => 'Client\\PlanningBundle\\ClientPlanningBundle',
            ...
            'database_user' => 'Main_user',
            'database_password' => 'Chmod777',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'huxtra@gmail.com',
            'mailer_password' => 'Sm@Joad.',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'huxtra@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Sm@Joad.',
            ...
            'fos_user.model.user.class' => 'Client\\PlanningBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'huxtra@gmail.com' => 'huxtra@gmail.com',
            ],
