...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'appbundle\\controller\\calendarcontroller' => 'AppBundle\\Controller\\CalendarController',
        ...
        $this->fileMap = [
            'AppBundle\\Controller\\CalendarController' => 'getCalendarControllerService.php',
